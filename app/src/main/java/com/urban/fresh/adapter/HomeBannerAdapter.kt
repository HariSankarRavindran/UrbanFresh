...
class HomeBannerAdapter(
    var context: Context,
    var data: List<DAOHomeDetails.Component.StaticBanner>
) :
    RecyclerView.Adapter<HomeBannerAdapter.HomeViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_home_banner, parent, false)
